...
function LoginPage() {
    ...
    const handleEmailLogin = async ()=>{
        ...
        try {
            ...
            if (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Invalid email or password");
                setIsLoading(false);
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("An unexpected error occurred: " + (err?.message ?? ""));
            console.error(err);
            setIsLoading(false);
        }
    };
    const handleGoogleSignIn = async ()=>{
        ...
        // Browser is automatically redirected to Google on success
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Could not sign in with Google: " + (err?.message ?? ""));
            console.error(err);
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6e9b620._.js.map