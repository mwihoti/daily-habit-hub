      ...
      <div className="container py-6 md:py-12 max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Top streaks in the FitTribe community. Updated every minute.
          </p>
        </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative">
                <Avatar
                  className="w-18 h-18 border-4 border-yellow-500/50 mb-2"
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <h2 className="text-2xl font-bold">
                Why the workout streak leaderboard exists
              </h2>
              <p className="text-muted-foreground">
                The FitTribe leaderboard turns consistency into something
                visible. Members can compare workout streaks, total check-ins,
                and community momentum without losing the simplicity of a daily
                habit tracker.
              </p>
              <p className="text-muted-foreground">
                For people searching for a workout streak tracker or
                accountability fitness app, this page shows how public rankings
                support motivation and routine-building.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Card>
              <CardContent className="p-5 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Learn how daily check-ins, streaks, and routine-building fit
                  into the wider product.
                </p>
                <a
            ...
            <Card>
              <CardContent className="p-5 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Rankings matter more when they sit beside a live workout
            ...
            <Card>
              <CardContent className="p-5 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  FitTribe combines public streaks with blockchain fitness
                  rewards and milestone badges.
                </p>
                <a
